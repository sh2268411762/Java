...
public class BooleanMethod
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("（静态方法）比较数值——>相等为0，大于为1，小于为-1：" + Boolean.compare(b1, b2) + " " + Boolean.compare(b2, b1)
				+ " " + Boolean.compare(b1, b3));
		...
		System.out.println("(静态方法）将指定字符串解析成boolean基本类型，不区分字母大小写：" + Boolean.parseBoolean("false") + " "
