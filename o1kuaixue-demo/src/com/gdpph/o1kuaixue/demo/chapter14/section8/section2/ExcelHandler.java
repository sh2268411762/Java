package com.gdpph.o1kuaixue.demo.chapter14.section8.section2;
        ...
        try {
            ...
            for (int i = 0; i < rowLength; i++) {
                ...
                for (int j = 0; j < colLength; j++) {
                    ...
                    System.out.print("原来的值为：" + cell.getStringCellValue() + "\t");
                    cell.setCellValue(cell.getStringCellValue() + i + j +"\t");
                    System.out.println("修改后的值为：" + cell.getStringCellValue() + "\t");
                }
                System.out.println();
            }
            //写入Excel文件
